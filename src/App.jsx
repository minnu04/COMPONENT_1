...
import BookCard from './components/bookcard'; // Import stays lowercase to match the filename
...
function App() {
  ...
  return (
    <div className="book-list" style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
      {books.map((book) => (
        <BookCard
          key={ book.id }
          image={ book.image }
